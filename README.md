...
│   ├── data/        # Data files (resume, projects, etc.)
...
1. Update personal information in `src/data/` directory:
   - `resume/work.js` - Work experience
   - `resume/degrees.js` - Education
   - `resume/skills.js` - Technical skills
   - `resume/courses.js` - Relevant coursework
   - `projects.js` - Projects portfolio
   - `about.md` - About page content
   - `contact.js` - Contact information

2. Update the site title and metadata in:
   - `src/layouts/Main.js`
   - `src/pages/Index.js`
